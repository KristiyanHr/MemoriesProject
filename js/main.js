document.addEventListener("DOMContentLoaded", () => {
  ...
  // A. Create the random background stars for this section
  const journeyStarsContainer = document.getElementById(
    "journey-stars-container"
  );
  if (journeyStarsContainer) {
    ...
    for (let i = 0; i < numberOfStars; i++) {
      ...
      journeyStarsContainer.appendChild(star);
    }
  }
  ...
  if (constellationHolder) observer.observe(constellationHolder);
